...
def main():
    st.title("🏠 House Price Predictor with Linear Regression")
    st.write("Enter the size of the house and get an estimated price!")

    model = train_model()
    size = st.number_input('House size (in sqft)', min_value=500, max_value=2000, value=1500)
